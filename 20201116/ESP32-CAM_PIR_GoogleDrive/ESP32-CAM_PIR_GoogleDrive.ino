...
//輸入Wi-Fi帳密
const char* ssid     = "EJ";   //Wi-Fi帳號
const char* password = "10656029";   //Wi-Fi密碼
int pinPIR = 13;   //人體移動感測器腳位 

String s_connectionString = "HostName=treasureIoTHub.azure-devices.net;DeviceId=esp32-cam;SharedAccessKey=PvVrSca5M9LgIHqeK/whRiYWTbpVyLXBmsnNgmAQrJI=";

const char* myDomain = "script.google.com";
String myScript = "/macros/s/AKfycbxdbGl_C-lbo5MeetNagwm2vmq8taAzLpcXvZUA3TO79VcYOw4/exec";    //設定Google Script路徑
String myFoldername = "&myFoldername=ESP32-CAM";    //設定Google drive存放影像資料夾名
String myFilename;    //設定Google drive存放影像檔名
...
void loop()
{
  ...
  if (v==1) {
    ...
    myFilename = "&myFilename=f"+String(j);
